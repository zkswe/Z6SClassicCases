...
static ZKListView* mPopupListviewPtr;
static ZKWindow* mPopupWindowPtr;
static ZKTextView* mTextview3Ptr;
static ZKButton* mMonButtonPtr;
static ZKTextView* mTextview2Ptr;
static ZKButton* mYearButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_MonButton, onButtonClick_MonButton,
    ID_MAIN_YearButton, onButtonClick_YearButton,
};
/***************/
...
static S_ListViewFunctionsCallback SListViewFunctionsCallbackTab[] = {
    ID_MAIN_PopupListview, getListItemCount_PopupListview, obtainListItemData_PopupListview, onListItemClick_PopupListview,
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mPopupListviewPtr = (ZKListView*)findControlByID(ID_MAIN_PopupListview);if(mPopupListviewPtr!= NULL){mPopupListviewPtr->setListAdapter(this);mPopupListviewPtr->setItemClickListener(this);}
    mPopupWindowPtr = (ZKWindow*)findControlByID(ID_MAIN_PopupWindow);
    mTextview3Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview3);
    mMonButtonPtr = (ZKButton*)findControlByID(ID_MAIN_MonButton);
    mTextview2Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview2);
    mYearButtonPtr = (ZKButton*)findControlByID(ID_MAIN_YearButton);
