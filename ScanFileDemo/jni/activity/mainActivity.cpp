...
static ZKEditText* mFileTypeEdittextPtr;
static ZKButton* mCurPathButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_CurPathButton, onButtonClick_CurPathButton,
};
/***************/
...
static S_EditTextInputCallback SEditTextInputCallbackTab[] = {
    ID_MAIN_FileTypeEdittext, onEditTextChanged_FileTypeEdittext,
};
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mFileTypeEdittextPtr = (ZKEditText*)findControlByID(ID_MAIN_FileTypeEdittext);if(mFileTypeEdittextPtr!= NULL){mFileTypeEdittextPtr->setTextChangeListener(this);}
    mCurPathButtonPtr = (ZKButton*)findControlByID(ID_MAIN_CurPathButton);
